...
hero:
  ...
  actions:
    ...
    - text: "Explore Free Apps"
      url: /install-guides/
  background_image: /aacforall/assets/img/hero-bg.png
---
...
<div class="container">
  ...
  <section class="features">
    <div class="feature">
    <img src="{{ site.baseurl }}/assets/img/aac-1.jpg" alt="Open-source apps">
      <h2>Open-Source AAC Apps</h2>
      <p>Free, offline apps like Cboard, Jabtalk, Jellow & more.</p>
    </div>
    <div class="feature">
      <img src="{{ site.baseurl }}/assets/img/aac-2.jpg" alt="Setup guides">
      <h2>Simple Setup Guides</h2>
      <p>Step-by-step PDFs for installing & pinning your AAC app.</p>
    </div>
    <div class="feature">
      <img src="{{ site.baseurl }}/assets/img/aac-3.png" alt="Rugged tablets">
